...
namespace JVStoreFront.UI.MVC.Controllers
{
    ...
    public class MediaTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MediaID,MediaType1")] MediaType mediaType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MediaID,MediaType1")] MediaType mediaType)
        {
            if (ModelState.IsValid)
            {
